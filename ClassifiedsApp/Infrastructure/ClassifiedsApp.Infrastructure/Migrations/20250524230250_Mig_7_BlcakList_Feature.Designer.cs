...
namespace ClassifiedsApp.Infrastructure.Migrations
{
    ...
    [Migration("20250524230250_Mig_7_BlcakList_Feature")]
    partial class Mig_7_BlcakList_Feature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassifiedsApp.Core.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClassifiedsApp.Core.Entities.ChatRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClassifiedsApp.Core.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasOne("ClassifiedsApp.Core.Entities.AppUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassifiedsApp.Core.Entities.ChatRoom", b =>
                {
                    ...
                    b.HasOne("ClassifiedsApp.Core.Entities.AppUser", "Buyer")
                        .WithMany()
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ClassifiedsApp.Core.Entities.AppUser", "Seller")
                        .WithMany()
